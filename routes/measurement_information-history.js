      ...
      connection_db.query(base_meas_query,function(err,user_row){
        if(err){
          ...
          if(user_row.length<=0){
            ...
            insert_baseline(req, res, iv, measurement_data, userid);
          }else{
            ...
            update_baseline(req, res, iv, measurement_data, userid);
          }
        }
      });
    }catch(e){
...
function update_baseline(req, res, iv, measurement_data, userid){
...
function update_measurementHistory(req, res, iv, userid, id, user_data, de_cryptdata){
    ...
    console.log(measure_histData.photoId + 'measure_histData.photoId');

   ...
   function hitWebsiteUrl(postUrl){
     ...
     request.post(
         ...
         function (error, response, body) {
             ...
             let emailBody = '', emailSubject = '', email_ids = web_notif_cron.cronEmail;
            //  console.log('error');
             if(error){
               // throw error;
              //  console.log('error');
               emailBody = error;
               emailUtil.sendEmail(emailBody, "", 'Cron AutoTap Error Response', "", "", email_ids,"Your Name","");
              ...
              //  console.log(response.body);
               ...
               // console.log(response.body);
                //  console.log(response.statusCode + 'Success');
                 ...
                 emailBody =  JSON.stringify(response);
                 emailUtil.sendEmail(emailBody, "", 'Cron AutoTap Success Response', "", "", email_ids,"Your Name","");
               ...
               emailBody =  JSON.stringify(response);
               emailUtil.sendEmail(emailBody, "", 'Cron AutoTap Exception Response', "", "", email_ids,"Your Name","");
    ...
    // hitWebsiteUrl("http://burg.rnf.tech:3000/signup");

...
var scheduleEmailFunction = {
  ...
  send_schedule_sgt_client : function (user_data, train_cb, license_cb, enroll_DateTime, hn_wo_port, enrollStatus){
    ...
    let gotribe_name = (user_data.first_name || "User") + " " +
                       (user_data.middle_name || "") + (user_data.last_name || "");

    let gotribe_staffname = (train_cb.first_name || "Trainer") + " " +
                            (train_cb.middle_name || "") +(train_cb.last_name || "");

    let gotribe_licname = (license_cb.first_name || "License") + " " +
                          (license_cb.middle_name || "") + (license_cb.last_name || "");
  ...
  cancel_schedule_by_ptopt_staff : function schedule_cancelled_by_ptopt_staff
      (user_data, train_cb, license_cb, enroll_DateTime, hn_wo_port, enrollStatus){

    console.log('enroll_DateTime ptopt_ staff');
  ...
  cancel_schedule_by_staff_ptopt_customer: function schedule_cancelled_by_staff_ptopt_customer
                (user_data, train_cb, license_cb, enroll_DateTime, hn_wo_port, enrollStatus){

    console.log('enroll_DateTime ptopt_ staff_customer');
    ...
    //
    // }
    filename = "templates/ejs-html/cancel_schedule_ptopt_customer.ejs";
  ...
  cancel_schedule_sgt_by_license_customer : function schedule_cancelled_by_license_sgt_customer
      (user_data, train_cb, license_cb, enroll_DateTime, hn_wo_port, enrollStatus){
    ...
    filename = "templates/ejs-html/cancel_schedule_sgt_by_license_customer.ejs";
  ...
  cancel_schedule_sgt_by_license_license: function schedule_cancelled_by_license_sgt_license
                ( train_cb, license_cb, enroll_DateTime, hn_wo_port, enrollStatus){
    ...
    //
    // }
    filename = "templates/ejs-html/cancel_schedule_sgt_by_license_license.ejs";
    ...
    ejs.renderFile( filename,
      ...
      if (err) {
        ...
        console.log('success');
          emailUtil.sendEmail(htmlData, "", emailSubject, "", "", license_cb.email,"Go tribe User","");
      }
  ...
  cancel_schedule_sgt_by_license_staff: function schedule_cancelled_by_license_sgt_staff
                ( train_cb, license_cb, enroll_DateTime, hn_wo_port, enrollStatus){
    ...
    //
    // }
    filename = "templates/ejs-html/cancel_schedule_sgt_by_license_staff.ejs";

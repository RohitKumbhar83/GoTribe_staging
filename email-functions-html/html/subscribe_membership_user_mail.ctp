          ...
          <tbody>
            ...
            <tr>
              <td><table  width="600" cellpadding="0" cellspacing="0" align="left">
                  <tbody>
                    <tr>
                      <td style="background:#fff; text-align:left;"><p>Hi <strong><?php echo $name;?>,</strong></p>
                        <p><strong style="color:#ed4934;">Congratulation!</strong> You have successfully subscribed for the <strong><?php echo $membership;?></strong> membership plan. Please find your info below.</p>

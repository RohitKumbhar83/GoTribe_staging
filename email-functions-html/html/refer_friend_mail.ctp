    ...
    <tr>
      <td align="center"><table width="600" style=" margin:0 auto;" cellpadding="0" cellspacing="0" border="0" align="center">
          <tbody>
            ...
            <tr>
              <td><table  width="600" cellpadding="0" cellspacing="0" align="left">
                  <tbody>
                    <tr>
                      <td style="background:#fff; text-align:left;"><p>Hi <strong>
                          <?php //echo $name;?>
                          ,</strong></p>
                        <p>Your fiend <strong><?php echo $name;?></strong> <?php echo $email;?> referred you to sign-up with <strong>GoTRIBE</strong>.</p>
                        <p style=" text-align:center;"><a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/member-registration" target="_blank" style="color: #444; background:#ed4934; color:#ffffff; text-decoration: none; padding:10px; display:inline-block; text-align:center;">Register Now</a></p>
                        <p>If you're having trouble clicking the Register Now link, copy and paste the below URL in your browser.</p>

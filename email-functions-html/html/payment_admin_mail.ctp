          ...
          <tbody>
            ...
            <tr>
              <td><table  width="600" cellpadding="0" cellspacing="0" align="left">
                  <tbody>
                    <tr>
                      <td style="background:#fff; text-align:left;"><p>Hi <strong><?php echo $adminName;?>,</strong></p>
                        <p><strong style="color:#ed4934;">Congratulation!</strong> A payment of <strong>$<?php echo $amount;?></strong> has been made for the customer <strong><?php echo $name;?>(<?php echo $username;?>)</strong>.</p>
                        <p><strong style="color:#ed4934; font-weight:bold; text-decoration: underline;">MEMBERSHIP DETAILS:</strong></p>
